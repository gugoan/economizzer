...
--
-- Table structure for table `produtos_clientes`
--

DROP TABLE IF EXISTS `produtos_clientes`;
...
CREATE TABLE `produtos_clientes` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `produtos_clientes_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`)
