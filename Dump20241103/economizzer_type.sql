...
CREATE TABLE `type` (
  ...
  PRIMARY KEY (`id_type`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Movement Type: Debit, Credit';
...
-- Dump completed on 2024-11-03 11:28:55
