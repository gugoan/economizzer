...
$this->title = Yii::t('app', 'Envio de PDF de Transações');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Livro Caixa'), 'url' => ['cashbook/index']];
...
<div class="pdf-upload-form container mt-5 p-4 rounded shadow-sm"
  ...
  <h1 class="text-center mb-3" style="font-weight: 600; font-size: 2em; color: #2c3e50;">Envio de PDF de Transações</h1>

  <p class="text-center mb-4" style="font-size: 1.1em; color: #5d6d7e;">
    Carregue seu arquivo PDF para registrar transações de forma fácil e rápida. Simplifique sua gestão financeira!
  </p>
  ...
  <div class="col-md-12">
    <?php $form = ActiveForm::begin([
      ...
      'options' => [
        ...
        'onsubmit' => 'showProgressBar()' // Ativa a barra de progresso no envio
      ],
    ]); ?>
    ...
    <div class="form-group text-center mb-4">
      ...
      <input type="file" id="file-upload" name="PdfUploadForm[file]" accept="application/pdf" style="display: none;" />
      <br>
    ...
    <div class="form-group text-center mt-4">
      <?= Html::submitButton('<i class="fa fa-upload"></i> ' . Yii::t('app', 'Enviar e Processar PDF'), [
        'class' => 'btn',
