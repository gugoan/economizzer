...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Jan-2015 às 20:31
...
CREATE TABLE IF NOT EXISTS `tb_cashbook` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_economizzer_category` (`category_id`),
  KEY `fk_economizzer_type` (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Control financial movement' AUTO_INCREMENT=166 ;
...
(148, 10, 2, -40, 'dez 2014', '2014-12-17', 0, 'comprovante_vivo_dez2014.pdf', '2014-12-21 15:57:46', '2014-12-21 15:57:46'),
(149, 6, 2, -329, 'Placa de Video', '2014-12-21', 0, 'comprovante_placavideo.pdf', '2014-12-21 15:59:33', '2014-12-21 15:59:33'),
(150, 6, 2, -27.66, 'IPTU 2014 Parc Pend', '2014-12-17', 0, 'comprovante_IPTU2014_Parc_Pend.pdf', '2014-12-21 16:00:20', '2014-12-21 16:00:20'),
(151, 6, 2, -160, 'DIV ATIV IPTU', '2014-12-17', 0, 'comprovante_IPTU_DIV_ATIV.pdf', '2014-12-21 16:01:13', '2014-12-21 16:01:13'),
(152, 1, 1, 800, 'Parcela restante 13º', '2014-12-18', 0, NULL, '2014-12-21 16:01:48', '2014-12-21 16:01:48'),
(153, 12, 2, -51, 'Pago pela Ju', '2014-12-23', 0, 'comprovante_tv_nov2014.pdf', '2014-12-25 18:26:48', '2014-12-25 18:26:48'),
(154, 11, 2, -56, 'Pago pela Ju', '2014-12-23', 0, 'comprovante_net_nov2014.pdf', '2014-12-25 18:29:16', '2014-12-25 18:29:16'),
(155, 11, 1, 0, 'Pago pela Ju (R$ 54,90)', '2015-01-01', 0, 'comprovante_net_jan2015.pdf', '2014-12-25 18:31:38', '2014-12-25 18:31:38'),
(156, 12, 1, 0, 'Pago pela Ju (R$ 49,90)', '2015-01-01', 0, 'comprovante_tv_jan2015.pdf', '2014-12-25 18:33:54', '2014-12-25 18:33:54'),
(157, 8, 2, -26, 'Mes Referencia Nov 2014', '2014-12-29', 0, 'comprovante_saae_mes_ref_nov_2014.pdf', '2014-12-28 16:00:15', '2014-12-28 16:00:15'),
(158, 1, 1, 1641, 'Jan 2014', '2015-01-05', 0, NULL, '2015-01-04 13:03:05', '2015-01-04 13:03:05'),
(159, 6, 1, 147, 'UOL Afiliados 35+35+42+33', '2015-01-05', 0, NULL, '2015-01-04 13:05:47', '2015-01-04 13:05:47'),
(160, 6, 2, -196, 'MCV Revisao 10K (P/Caixa)', '2015-01-05', 0, 'nfe_mcv_revisao_10k.pdf', '2015-01-04 13:09:43', '2015-01-04 13:09:43'),
(161, 16, 2, -292, 'DPVAT 2015 (MOTO)', '2015-01-06', 0, 'comprovante_DPVAT 2015_moto.pdf', '2015-01-06 08:44:22', '2015-01-06 08:44:22'),
(162, 6, 2, -85, 'IPVA 2015 - P. ÚNICA (mot', '2015-01-06', 0, 'comprovante_IPVA 2015 - PARCELA ÚNICA_moto.pdf', '2015-01-06 08:47:30', '2015-01-06 08:47:30'),
(163, 6, 2, -77, 'TRLAV 2015 - P ÚNICA (MOT', '2015-01-06', 0, 'comprovante_TRLAV 2015 - PARCELA UNICA_moto.pdf', '2015-01-06 08:49:11', '2015-01-06 08:49:11'),
(164, 13, 2, -377, 'Jan 2015', '2015-01-06', 0, 'comprovante_faturamastercard_jan2015.pdf', '2015-01-06 08:55:19', '2015-01-06 08:55:19'),
(165, 16, 2, -399, 'Parcela 10 de 60', '2015-01-09', 0, 'comprovante_carro_parcela10de60.pdf', '2015-01-09 03:50:22', '2015-01-09 03:50:22');
...
ALTER TABLE `tb_cashbook`
  ADD CONSTRAINT `fk_economizzer_category` FOREIGN KEY (`category_id`) REFERENCES `tb_category` (`id_category`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_economizzer_type` FOREIGN KEY (`type_id`) REFERENCES `tb_type` (`id_type`) ON DELETE NO ACTION ON UPDATE NO ACTION;
